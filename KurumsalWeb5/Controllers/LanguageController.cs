...
namespace KurumsalWeb5.Controllers
{
    public class LanguageController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "LanguageId,Baslik,Language_code")] Language language)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "LanguageId,Baslik,Language_code")] Language language)
        {
            if (ModelState.IsValid)
            {
